...
#include <nil/crypto3/zk/snark/systems/stark/committed_trace.h>
...
namespace starkware {
    ...
    public:
        ...
        */
        ...
        MOCK_CONST_METHOD1(DecommitQueries, void(gsl::span<const std::tuple<uint64_t, uint64_t, size_t>>));
        MOCK_CONST_METHOD3(EvalMaskAtPoint, void(gsl::span<const std::pair<int64_t, uint64_t>>,
    ...
    public:
        ...
        MOCK_CONST_METHOD1_T(VerifyDecommitment,
